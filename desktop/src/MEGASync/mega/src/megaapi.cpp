...
const char* MegaTransfer::stageToString(unsigned stage)
{
    switch (stage)
    {
        case MegaTransfer::STAGE_NONE:
            return "Not initialized stage";
        case MegaTransfer::STAGE_SCAN:
            return "Scan stage";
        case MegaTransfer::STAGE_CREATE_TREE:
            return "Create tree stage";
        case MegaTransfer::STAGE_TRANSFERRING_FILES:
            return "Transferring files stage";
        default:
    ...
    if (errorCode <= 0)
    {
        switch (errorCode)
        {
            ...
            case API_ESUBUSERKEYMISSING:
                return "A business error where a subuser has not yet encrypted their master key "
                       "for "
                       "the admin user and tries to perform a disallowed command (currently u and "
                       "p)";
            case LOCAL_ENOSPC:
...
void SynchronousRequestListener::onRequestFinish(MegaApi* api,
                                                 MegaRequest* request,
                                                 MegaError* error)
{
    this->megaApi = api;
...
void SynchronousTransferListener::onTransferFinish(MegaApi* api,
...
{
    pImpl =
        new MegaApiImpl(this, appKey, provider, basePath, userAgent, workerThreadCount, clientType);
}
...
void MegaApi::retryPendingConnections(bool disconnect,
                                      bool includexfers,
...
void MegaApi::multiFactorAuthLogin(const char* email,
                                   const char* password,
                                   const char* pin,
                                   MegaRequestListener* listener)
{
...
void MegaApi::multiFactorAuthChangePassword(const char* oldPassword,
...
void MegaApi::multiFactorAuthChangeEmail(const char* email,
                                         const char* pin,
                                         MegaRequestListener* listener)
{
...
void MegaApi::sendUsedTransferQuotaDevCommand(long long quota,
                                              const char* email,
                                              MegaRequestListener* listener)
{
...
void MegaApi::sendBusinessStatusDevCommand(int businessStatus,
                                           const char* email,
                                           MegaRequestListener* listener)
{
...
void MegaApi::sendUserStatusDevCommand(int userStatus,
                                       const char* email,
                                       MegaRequestListener* listener)
{
...
void MegaApi::createAccount(const char* email,
                            const char* password,
                            ...
                            MegaRequestListener* listener)
{
    pImpl->createAccount(email,
                         ...
                         lastname,
                         UNDEF,
                         AFFILIATE_TYPE_INVALID,
                         0,
                         listener);
}

void MegaApi::createEphemeralAccountPlusPlus(const char* firstname,
                                             const char* lastname,
                                             MegaRequestListener* listener)
{
...
void MegaApi::confirmResetPassword(const char* link,
                                   const char* newPwd,
...
void MegaApi::checkRecoveryKey(const char* link,
                               const char* recoveryKey,
                               MegaRequestListener* listener)
{
...
void MegaApi::createPasswordNode(const char* name,
...
void MegaApi::updatePasswordNode(MegaHandle node,
                                 const MegaNode::PasswordNodeData* newData,
                                 MegaRequestListener* listener)
{
...
void MegaApi::moveNode(MegaNode* node,
                       MegaNode* newParent,
                       const char* newName,
                       MegaRequestListener* listener)
{
...
void MegaApi::copyNode(MegaNode* node,
                       MegaNode* newParent,
                       const char* newName,
                       MegaRequestListener* listener)
{
...
void MegaApi::importFileLink(const char* megaFileLink,
                             MegaNode* parent,
                             MegaRequestListener* listener)
{
...
void MegaApi::decryptPasswordProtectedLink(const char* link,
                                           const char* password,
                                           MegaRequestListener* listener)
{
...
void MegaApi::encryptLinkWithPassword(const char* link,
                                      const char* password,
                                      MegaRequestListener* listener)
{
...
void MegaApi::putThumbnail(MegaBackgroundMediaUpload* bu,
...
void MegaApi::setThumbnailByHandle(MegaNode* node,
                                   MegaHandle fileattribute,
                                   MegaRequestListener* listener)
{
...
void MegaApi::putPreview(MegaBackgroundMediaUpload* bu,
                         const char* srcFilePath,
                         MegaRequestListener* listener)
{
...
void MegaApi::setPreviewByHandle(MegaNode* node,
                                 MegaHandle fileattribute,
                                 MegaRequestListener* listener)
{
...
void MegaApi::getUserAvatar(const char* email_or_handle,
...
void MegaApi::getChatUserAttribute(const char* email_or_handle,
                                   int type,
                                   const char* ph,
                                   MegaRequestListener* listener)
{
...
void MegaApi::setCustomNodeAttribute(MegaNode* node,
                                     const char* attrName,
                                     const char* value,
                                     MegaRequestListener* listener)
{
...
void MegaApi::setNodeCoordinates(MegaNode* node,
                                 double latitude,
                                 double longitude,
                                 MegaRequestListener* listener)
{
...
void MegaApi::setUnshareableNodeCoordinates(MegaNode* node,
                                            double latitude,
                                            double longitude,
                                            MegaRequestListener* listener)
{
...
void MegaApi::setNodeDescription(MegaNode* node,
...
void MegaApi::updateNodeTag(MegaNode* node,
                            const char* newTag,
                            const char* oldTag,
                            MegaRequestListener* listener)
{
...
void MegaApi::exportNode(MegaNode* node,
                         int64_t expireTime,
                         bool writable,
                         bool megaHosted,
                         MegaRequestListener* listener)
...
void MegaApi::getSpecificAccountDetails(bool storage,
                                        bool transfer,
                                        bool pro,
                                        int source,
                                        MegaRequestListener* listener)
...
void MegaApi::getExtendedAccountDetails(bool sessions,
                                        bool purchases,
                                        bool transactions,
                                        MegaRequestListener* listener)
{
...
void MegaApi::upgradeAccount(MegaHandle productHandle,
                             int paymentMethod,
                             MegaRequestListener* listener)
{
...
void MegaApi::submitPurchaseReceipt(int gateway,
                                    const char* receipt,
                                    MegaHandle lastPublicHandle,
                                    MegaRequestListener* listener)
{
    pImpl->submitPurchaseReceipt(gateway,
                                 receipt,
                                 lastPublicHandle,
                                 AFFILIATE_TYPE_INVALID,
                                 0,
...
void MegaApi::creditCardStore(const char* address1,
                              const char* address2,
                              const char* city,
                              const char* province,
                              const char* country,
                              ...
                              const char* expire_month,
                              const char* expire_year,
                              const char* cv2,
                              MegaRequestListener* listener)
{
    pImpl->creditCardStore(address1,
                           address2,
                           city,
                           province,
                           country,
...
{
    pImpl->getUserAttr((const char*)NULL,
                       MegaApi::USER_ATTR_PWD_REMINDER,
                       NULL,
                       atLogout,
                       listener);
}
...
void MegaApi::setPushNotificationSettings(MegaPushNotificationSettings* settings,
                                          MegaRequestListener* listener)
{
...
MegaScheduledMeeting* MegaScheduledMeeting::createInstance(MegaHandle chatid,
                                                           MegaHandle schedId,
                                                           MegaHandle parentSchedId,
                                                           MegaHandle organizerUserId,
                                                           int cancelled,
                                                           const char* timezone,
                                                           ...
                                                           MegaTimeStamp overrides,
                                                           MegaScheduledFlags* flags,
                                                           MegaScheduledRules* rules)
{
    return new MegaScheduledMeetingPrivate(chatid,
                                           timezone,
                                           startDateTime,
                                           endDateTime,
                                           title,
...
int MegaScheduledMeeting::cancelled() const
{
    return 0;
}

MegaHandle MegaScheduledMeeting::chatid() const
{
    return INVALID_HANDLE;
}

MegaHandle MegaScheduledMeeting::schedId() const
{
    return INVALID_HANDLE;
}

MegaHandle MegaScheduledMeeting::organizerUserid() const
{
    return INVALID_HANDLE;
}

MegaHandle MegaScheduledMeeting::parentSchedId() const
{
    return INVALID_HANDLE;
}

MegaScheduledMeeting* MegaScheduledMeeting::copy() const
{
    return NULL;
}

const char* MegaScheduledMeeting::timezone() const
{
    return NULL;
}

MegaTimeStamp MegaScheduledMeeting::startDateTime() const
{
    return MEGA_INVALID_TIMESTAMP;
}

MegaTimeStamp MegaScheduledMeeting::endDateTime() const
{
    return MEGA_INVALID_TIMESTAMP;
}

const char* MegaScheduledMeeting::title() const
{
    return NULL;
}

const char* MegaScheduledMeeting::description() const
{
    return NULL;
}

const char* MegaScheduledMeeting::attributes() const
{
    return NULL;
}

MegaTimeStamp MegaScheduledMeeting::overrides() const
{
    return MEGA_INVALID_TIMESTAMP;
}
...
MegaScheduledFlags* MegaScheduledMeeting::flags() const
{
    return NULL;
}
...
bool MegaScheduledFlags::isEmpty() const
{
    return false;
}

unsigned long MegaScheduledFlags::getNumericValue() const
{
    return ScheduledFlags::schedEmptyFlags;
}
...
{
    return new MegaScheduledRulesPrivate(freq,
                                         interval,
                                         until,
                                         byWeekDay,
                                         byMonthDay,
...
MegaScheduledRules* MegaScheduledRules::copy() const
{
    return NULL;
}

int MegaScheduledRules::freq() const
{
    return 0;
}

int MegaScheduledRules::interval() const
{
    return 0;
}

MegaTimeStamp MegaScheduledRules::until() const
{
    return MEGA_INVALID_TIMESTAMP;
}

const mega::MegaIntegerList* MegaScheduledRules::byWeekDay() const
{
    return nullptr;
}

const mega::MegaIntegerList* MegaScheduledRules::byMonthDay() const
{
    return nullptr;
}

const mega::MegaIntegerMap* MegaScheduledRules::byMonthWeekDay() const
{
    return nullptr;
}

bool MegaScheduledRules::isValidFreq(int freq)
{
    return MegaScheduledRulesPrivate::isValidFreq(freq);
}

bool MegaScheduledRules::isValidInterval(int interval)
{
    return MegaScheduledRulesPrivate::isValidInterval(interval);
}
...
MegaScheduledMeetingList* MegaScheduledMeetingList::copy() const
{
    return NULL;
}

unsigned long MegaScheduledMeetingList::size() const
{
    return 0;
}

MegaScheduledMeeting* MegaScheduledMeetingList::at(unsigned long) const
{
    return NULL;
}

MegaScheduledMeeting* MegaScheduledMeetingList::getBySchedId(MegaHandle) const
{
    return NULL;
}
...
void MegaApi::setCameraUploadsFolders(MegaHandle primaryFolder,
                                      MegaHandle secondaryFolder,
                                      MegaRequestListener* listener)
{
...
void MegaApi::setDeviceName(const char* deviceId,
...
void MegaApi::setDriveName(const char* pathToDrive,
...
void MegaApi::changePassword(const char* oldPassword,
                             const char* newPassword,
                             MegaRequestListener* listener)
{
...
void MegaApi::sendEvent(int eventType,
                        const char* message,
                        bool addJourneyId,
                        const char* viewId,
                        MegaRequestListener* listener)
...
void MegaApi::inviteContact(const char* email,
                            const char* message,
                            int action,
                            MegaRequestListener* listener)
{
...
void MegaApi::startUploadForSupport(const char* localPath,
...
void MegaApi::setScheduledCopy(const char* localPath,
                               MegaNode* parent,
                               bool attendPastBackups,
                               int64_t period,
                               const char* periodstring,
                               int numBackups,
                               MegaRequestListener* listener)
{
    pImpl->setScheduledCopy(localPath,
                            parent,
                            attendPastBackups,
                            period,
...
void MegaApi::startUpload(const char* localPath,
                          MegaNode* parent,
                          const char* fileName,
                          int64_t mtime,
                          const char* appData,
...
void MegaApi::startUploadForChat(const char* localPath,
                                 MegaNode* parent,
                                 const char* appData,
                                 bool isSourceTemporary,
                                 const char* fileName,
...
void MegaApi::startDownload(MegaNode* node,
                            ...
                            MegaTransferListener* listener)
{
    pImpl->startDownload(startFirst,
                         node,
                         localPath,
                         customName,
                         0 /*folderTransferTag*/,
...
void MegaApi::moveTransferBefore(MegaTransfer* transfer,
                                 MegaTransfer* prevTransfer,
                                 MegaRequestListener* listener)
{
    pImpl->moveTransferBefore(transfer ? transfer->getTag() : 0,
                              prevTransfer ? prevTransfer->getTag() : 0,
                              listener);
}

void MegaApi::moveTransferBeforeByTag(int transferTag,
                                      int prevTransferTag,
                                      MegaRequestListener* listener)
{
...
void MegaApi::startStreaming(MegaNode* node,
                             int64_t startPos,
                             int64_t size,
                             MegaTransferListener* listener)
{
...
void MegaApi::loadExternalBackupSyncsFromExternalDrive(const char* externalDriveRoot,
                                                       MegaRequestListener* listener)
{
    pImpl->loadExternalBackupSyncsFromExternalDrive(externalDriveRoot, listener);
}

void MegaApi::closeExternalBackupSyncsFromExternalDrive(const char* externalDriveRoot,
                                                        MegaRequestListener* listener)
{
    pImpl->closeExternalBackupSyncsFromExternalDrive(externalDriveRoot, listener);
}

void MegaApi::copySyncDataToCache(const char* localFolder,
                                  const char* name,
                                  ...
                                  MegaRequestListener* listener)
{
    pImpl->copySyncDataToCache(localFolder,
                               name,
                               megaHandle,
                               remotePath,
                               localfp,
...
void MegaApi::copyCachedStatus(int storageStatus,
                               int blockStatus,
                               int businessStatus,
                               MegaRequestListener* listener)
{
...
void MegaApi::setSyncRunState(MegaHandle backupId,
                              MegaSync::SyncRunningState targetState,
                              MegaRequestListener* listener)
{
...
void MegaApi::moveOrRemoveDeconfiguredBackupNodes(MegaHandle deconfiguredBackupRoot,
                                                  MegaHandle backupDestination,
                                                  MegaRequestListener* listener)
{
...
MegaNode* MegaApi::createForeignFileNode(MegaHandle handle,
                                         const char* key,
                                         const char* name,
                                         int64_t size,
                                         int64_t mtime,
                                         const char* fingerprintCrc,
                                         MegaHandle parentHandle,
                                         const char* privateAuth,
                                         const char* publicAuth,
                                         const char* chatAuth)
{
    return pImpl->createForeignFileNode(handle,
                                        key,
                                        name,
                                        size,
                                        mtime,
...
MegaNode* MegaApi::createForeignFolderNode(MegaHandle handle,
                                           const char* name,
                                           MegaHandle parentHandle,
                                           const char* privateAuth,
                                           const char* publicAuth)
...
MegaNodeList* MegaApi::search(const MegaSearchFilter* filter,
                              int order,
                              MegaCancelToken* cancelToken,
...
MegaNodeList* MegaApi::getNodesByOriginalFingerprint(const char* originalFingerprint,
                                                     MegaNode* parent)
{
...
MegaNodeList* MegaApi::getChildren(const MegaSearchFilter* filter,
                                   int order,
                                   MegaCancelToken* cancelToken,
                                   const MegaSearchPage* searchPage)
{
...
void MegaApi::sendSMSVerificationCode(const char* phoneNumber,
                                      MegaRequestListener* listener,
                                      bool reverifying_whitelisted)
{
...
#ifdef HAVE_LIBUV
bool MegaApi::httpServerStart(bool localOnly,
                              int port,
                              bool useTLS,
...
// FTP Server:
bool MegaApi::ftpServerStart(bool localOnly,
                             int port,
                             int dataportBegin,
                             int dataPortEnd,
                             bool useTLS,
                             ...
                             const char* keypath)
{
    return pImpl->ftpServerStart(localOnly,
                                 port,
                                 dataportBegin,
                                 dataPortEnd,
                                 useTLS,
...
#ifdef ENABLE_CHAT
void MegaApi::createChat(bool group,
                         MegaTextChatPeerList* peers,
                         const char* title,
                         int chatOptions,
                         const MegaScheduledMeeting* scheduledMeeting,
                         MegaRequestListener* listener)
{
...
void MegaApi::createPublicChat(MegaTextChatPeerList* peers,
                               const MegaStringMap* userKeyMap,
                               const char* title,
                               bool meetingRoom,
                               int chatOptions,
                               const MegaScheduledMeeting* scheduledMeeting,
...
void MegaApi::setChatOption(MegaHandle chatid,
                            int option,
                            bool enabled,
                            MegaRequestListener* listener)
{
...
void MegaApi::createOrUpdateScheduledMeeting(const MegaScheduledMeeting* scheduledMeeting,
...
void MegaApi::removeScheduledMeeting(MegaHandle chatid,
                                     MegaHandle schedId,
                                     MegaRequestListener* listener)
{
...
void MegaApi::fetchScheduledMeeting(MegaHandle chatid,
                                    MegaHandle schedId,
                                    MegaRequestListener* listener)
{
...
void MegaApi::fetchScheduledMeetingEvents(MegaHandle chatid,
                                          MegaTimeStamp since,
                                          MegaTimeStamp until,
                                          unsigned int count,
                                          MegaRequestListener* listener)
...
void MegaApi::inviteToChat(MegaHandle chatid,
                           MegaHandle uh,
                           int privilege,
                           const char* title,
                           MegaRequestListener* listener)
...
void MegaApi::inviteToPublicChat(MegaHandle chatid,
                                 MegaHandle uh,
                                 int privilege,
...
void MegaApi::grantAccessInChat(MegaHandle chatid,
                                MegaNode* n,
                                MegaHandle uh,
                                MegaRequestListener* listener)
{
...
void MegaApi::removeAccessInChat(MegaHandle chatid,
                                 MegaNode* n,
                                 MegaHandle uh,
                                 MegaRequestListener* listener)
{
...
void MegaApi::updateChatPermissions(MegaHandle chatid,
                                    MegaHandle uh,
                                    int privilege,
                                    MegaRequestListener* listener)
{
...
void MegaApi::registerPushNotifications(int deviceType,
                                        const char* token,
                                        MegaRequestListener* listener)
{
...
void MegaApi::sendChatLogs(const char* data,
                           MegaHandle userid,
                           MegaHandle callid,
                           int port,
                           MegaRequestListener* listener)
...
void MegaApi::setChatRetentionTime(MegaHandle chatid,
                                   unsigned period,
                                   MegaRequestListener* listener)
{
...
void MegaApi::chatLinkJoin(MegaHandle publichandle,
                           const char* unifiedKey,
                           MegaRequestListener* listener)
{
...
void MegaApi::endChatCall(MegaHandle chatid,
                          MegaHandle callid,
                          int reason,
                          MegaRequestListener* listener)
{
...
void MegaApi::ringIndividualInACall(MegaHandle chatid,
                                    MegaHandle userid,
                                    MegaRequestListener* listener)
{
...
void MegaApi::utf16ToUtf8(const wchar_t* utf16data, int utf16size, string* utf8string)
{
    ...
    utf8string->resize(WideCharToMultiByte(CP_UTF8,
                                           0,
                                           utf16data,
                                           utf16size,
...
void MegaApi::utf8ToUtf16(const char* utf8data, string* utf16string)
{
    ...
    utf16string->resize(sizeof(wchar_t) *
...
void MegaApi::backgroundMediaUploadRequestUploadURL(int64_t fullFileSize,
...
void MegaApi::completeUpload(const char* utf8Name,
                             MegaNode* parent,
                             ...
                             MegaRequestListener* listener)
{
    return pImpl->completeUpload(utf8Name,
                                 parent,
                                 fingerprint,
                                 fingerprintoriginal,
                                 string64UploadToken,
...
void MegaApi::backgroundMediaUploadComplete(MegaBackgroundMediaUpload* state,
                                            const char* utf8Name,
                                            MegaNode* parent,
                                            const char* fingerprint,
                                            const char* fingerprintoriginal,
                                            ...
                                            MegaRequestListener* listener)
{
    pImpl->backgroundMediaUploadComplete(state,
                                         utf8Name,
                                         parent,
                                         fingerprint,
                                         fingerprintoriginal,
...
void MegaApi::setOriginalFingerprint(MegaNode* node,
...
void MegaApi::setBackup(int backupType,
...
void MegaApi::updateBackup(MegaHandle backupId,
                           int backupType,
                           MegaHandle targetNode,
                           const char* localFolder,
                           const char* backupName,
...
void MegaApi::removeFromBC(MegaHandle backupId,
                           MegaHandle moveDestination,
                           MegaRequestListener* listener)
{
...
void MegaApi::sendBackupHeartbeat(MegaHandle backupId,
                                  int status,
                                  int progress,
                                  int ups,
                                  int downs,
...
void MegaApi::fetchAds(int adFlags,
                       MegaStringList* adUnits,
                       MegaHandle publicHandle,
                       MegaRequestListener* listener)
{
...
void MegaApi::createSetElements(MegaHandle sid,
                                const MegaHandleList* nodes,
                                const MegaStringList* names,
                                MegaRequestListener* listener)
{
    pImpl->putSetElements(sid, nodes, names, listener);
}

void MegaApi::createSetElement(MegaHandle sid,
                               MegaHandle node,
                               const char* name,
                               MegaRequestListener* listener)
{
...
void MegaApi::updateSetElementOrder(MegaHandle sid,
                                    MegaHandle eid,
                                    int64_t order,
                                    MegaRequestListener* listener)
{
...
void MegaApi::updateSetElementName(MegaHandle sid,
                                   MegaHandle eid,
                                   const char* name,
                                   MegaRequestListener* listener)
{
...
void MegaApi::removeSetElements(MegaHandle sid,
                                const MegaHandleList* eids,
                                MegaRequestListener* listener)
{
...
void MegaApi::disableMount(const char* path, MegaRequestListener* listener, bool remember)
{
    assert(listener);
    assert(path);
...
void MegaApi::enableMount(const char* path, MegaRequestListener* listener, bool remember)
{
    assert(listener);
    assert(path);
...
void MegaApi::enableTestNotifications(const MegaIntegerList* notificationIds,
                                      MegaRequestListener* listener)
{
...
void MegaLogger::log(const char* /*time*/,
                     int /*loglevel*/,
                     const char* /*source*/,
                     const char* /*message*/
...
MegaApiLock::MegaApiLock(MegaApiImpl* ptr, bool lock):
    api(ptr)
{
    if (lock)
    {
...
void MegaPushNotificationSettings::setGlobalSchedule(int /*start*/,
                                                     int /*end*/,
                                                     const char* /*timezone*/)
{}
