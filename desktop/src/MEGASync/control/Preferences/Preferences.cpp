...
const QString Preferences::USER_AGENT =
    QString::fromUtf8("%1/%2").arg(QString::fromUtf8(VER_FILEDESCRIPTION_STR),
...
const QString Preferences::VERSION_STRING =
    QString::fromUtf8(VER_PRODUCTVERSION_STR)
        .left(QString::fromUtf8(VER_PRODUCTVERSION_STR).lastIndexOf(QLatin1Char('.')));
...
std::chrono::milliseconds Preferences::OVER_QUOTA_DIALOG_DISABLE_DURATION{
    std::chrono::hours(7 * 24)};
std::chrono::milliseconds Preferences::OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION{
    std::chrono::hours(36)};
std::chrono::milliseconds Preferences::OVER_QUOTA_UI_ALERT_DISABLE_DURATION{std::chrono::hours(36)};
std::chrono::milliseconds Preferences::ALMOST_OVER_QUOTA_UI_ALERT_DISABLE_DURATION{
    std::chrono::hours(72)};
std::chrono::milliseconds Preferences::ALMOST_OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION{
    std::chrono::hours(36)};
std::chrono::milliseconds Preferences::OVER_QUOTA_ACTION_DIALOGS_DISABLE_TIME{
    std::chrono::hours{12}};
...
const QStringList Preferences::HTTPS_ALLOWED_ORIGINS =
    QStringList() << Preferences::BASE_URL << QLatin1String("https://mega.co.nz")
                  << QLatin1String("chrome-extension://*") << QLatin1String("moz-extension://*")
...
#ifdef WIN32
#ifdef _WIN64
const QString Preferences::UPDATE_CHECK_URL =
    QString::fromUtf8("http://g.static.mega.co.nz/upd/wsync64/v.txt");
#else
const QString Preferences::UPDATE_CHECK_URL =
    QString::fromUtf8("http://g.static.mega.co.nz/upd/wsync/v.txt");
#endif
#else
#if defined(__arm64__)
const QString Preferences::UPDATE_CHECK_URL =
    QString::fromUtf8("http://g.static.mega.co.nz/upd/msyncarm64/v.txt");
#else
const QString Preferences::UPDATE_CHECK_URL = QString::fromUtf8(
    "http://g.static.mega.co.nz/upd/msyncv2/v.txt"); // Using msyncv2 to serve new updates and avoid
                                                     // keeping loader leftovers
#endif
#endif
...
const QString Preferences::CRASH_REPORT_URL =
    QString::fromUtf8("http://g.api.mega.co.nz/hb?crashdump");
...
const QString Preferences::overStorageDialogExecutionKey =
    QString::fromLatin1("overStorageDialogExecution");
const QString Preferences::overStorageNotificationExecutionKey =
    QString::fromLatin1("overStorageNotificationExecution");
const QString Preferences::almostOverStorageDialogExecutionKey =
    QString::fromLatin1("almostOverStorageDialogExecution");
const QString Preferences::almostOverStorageNotificationExecutionKey =
    QString::fromLatin1("almostOverStorageNotificationExecution");
const QString Preferences::payWallNotificationExecutionKey =
    QString::fromLatin1("payWallNotificationExecution");
const QString Preferences::almostOverStorageDismissExecutionKey =
    QString::fromLatin1("almostOverStorageDismissExecution");
const QString Preferences::overStorageDismissExecutionKey =
    QString::fromLatin1("overStorageDismissExecution");
...
const QString Preferences::transferOverQuotaDialogLastExecutionKey =
    QString::fromLatin1("transferOverQuotaDialogLastExecution");
const QString Preferences::transferOverQuotaOsNotificationLastExecutionKey =
    QString::fromLatin1("transferOverQuotaOsNotificationLastExecution");
const QString Preferences::transferAlmostOverQuotaOsNotificationLastExecutionKey =
    QString::fromLatin1("transferAlmostOverQuotaOsNotificationLastExecution");
const QString Preferences::transferAlmostOverQuotaUiAlertLastExecutionKey =
    QString::fromLatin1("transferAlmostOverQuotaUiAlertLastExecution");
const QString Preferences::transferOverQuotaUiAlertLastExecutionKey =
    QString::fromLatin1("transferOverQuotaUiAlertDisableUntil");

const QString Preferences::transferOverQuotaSyncDialogLastExecutionKey =
    QString::fromLatin1("transferOverQuotaSyncDialogLastExecution");
const QString Preferences::transferOverQuotaDownloadsDialogLastExecutionKey =
    QString::fromLatin1("transferOverQuotaDownloadsDialogLastExecution");
const QString Preferences::transferOverQuotaImportLinksDialogLastExecutionKey =
    QString::fromLatin1("transferOverQuotaImportLinksDialogLastExecution");
const QString Preferences::transferOverQuotaStreamDialogLastExecutionKey =
    QString::fromLatin1("transferOverQuotaStreamDialogLastExecution");
const QString Preferences::storageOverQuotaUploadsDialogLastExecutionKey =
    QString::fromLatin1("storageOverQuotaUploadsDialogLastExecution");
const QString Preferences::storageOverQuotaSyncsDialogLastExecutionKey =
    QString::fromLatin1("storageOverQuotaSyncsDialogLastExecution");

const bool Preferences::defaultShowNotifications = true;

const bool Preferences::defaultDeprecatedNotifications = true;
const QString Preferences::showDeprecatedNotificationsKey =
    QString::fromLatin1("showNotifications");

// Stalled Issues
const Preferences::StalledIssuesModeType Preferences::defaultStalledIssuesMode =
...
const QString Preferences::stalledIssuesEventDateKey =
    QString::fromLatin1("stalledIssuesEventDate");
...
const QString Preferences::parallelUploadConnectionsKey =
    QString::fromLatin1("parallelUploadConnections");
const QString Preferences::parallelDownloadConnectionsKey =
    QString::fromLatin1("parallelDownloadConnections");
...
const QString Preferences::hasDefaultUploadFolderKey =
    QString::fromLatin1("hasDefaultUploadFolder");
const QString Preferences::hasDefaultDownloadFolderKey =
    QString::fromLatin1("hasDefaultDownloadFolder");
...
const QString Preferences::SSLcertificateExceptionKey =
    QString::fromLatin1("SSLcertificateException");
...
const QString Preferences::lastPublicHandleTimestampKey =
    QString::fromLatin1("lastPublicHandleTimestamp");
...
const QString Preferences::importMegaLinksEnabledKey =
    QString::fromLatin1("importMegaLinksEnabled");
const QString Preferences::downloadMegaLinksEnabledKey =
    QString::fromLatin1("downloadMegaLinksEnabled");
const QString Preferences::systemTrayPromptSuppressed =
    QString::fromLatin1("systemTrayPromptSuppressed");
const QString Preferences::systemTrayLastPromptTimestamp =
    QString::fromLatin1("systemTrayLastPromptTimestamp");
...
const unsigned long long Preferences::defaultUpperSizeLimitValue =
    1; // Input UI range 1-9999. Use 1 as default value
const unsigned long long Preferences::defaultLowerSizeLimitValue =
    1; // Input UI range 1-9999. Use 1 as default value
...
void Preferences::initialize(QString dataPath)
{
    ...
    QString lockSettingsFile =
        QDir::toNativeSeparators(dataPath + QString::fromLatin1("/MEGAsync.cfg.lock"));
    QFile::remove(lockSettingsFile);

    QDir dir(dataPath);
    dir.mkpath(QString::fromLatin1("."));
    QString settingsFile =
        QDir::toNativeSeparators(dataPath + QString::fromLatin1("/MEGAsync.cfg"));
    QString bakSettingsFile =
        QDir::toNativeSeparators(dataPath + QString::fromLatin1("/MEGAsync.cfg.bak"));
    ...
    if (currentAccount.size())
    {
        ...
        else
        {
            MegaApi::log(MegaApi::LOG_LEVEL_ERROR,
                         QString::fromUtf8("Settings does not contain current account group. Will "
    ...
    if (QFile::exists(bakSettingsFile) && retryFlag)
    {
        ...
        if (QFile::rename(bakSettingsFile, settingsFile))
        {
            ...
            if (currentAccount.size())
            {
                ...
                {
                    MegaApi::log(MegaApi::LOG_LEVEL_ERROR,
                                 QString::fromUtf8("Settings does not contain current account "
                                                   "group in backup setting either.")
                                     .toUtf8()
                                     .constData());
                    errorFlag = true;
                }
    ...
    if (errorFlag)
    {
        MegaApi::log(
            ...
            QString::fromUtf8("Cleaning settings after error encountered.").toUtf8().constData());
        clearAll();
    }
    else
    {
...
void Preferences::storeSessionInGeneral(QString session)
{
    ...
    if (logged())
    {
        mSettings->setValue(sessionKey,
                            session); // store in user group too (for backwards compatibility)
        mSettings->endGroup();
        currentAccount = mSettings->value(currentAccountKey).toString();
    }
...
QString Preferences::getSession()
{
    ...
    if (logged())
    {
        value = mSettings->value(sessionKey).toString(); // for MEGAsync prior unfinished fetchnodes
                                                         // resumable sessions (<=4.3.1)
    }

    if (value.isEmpty() && needsFetchNodesInGeneral())
    {
        value = getSessionInGeneral(); // for MEGAsync with unfinished fetchnodes resumable sessions
                                       // (>4.3.1)
    }
...
{
    assert(logged());
    return getValueConcurrent<long long>(almostOverStorageNotificationExecutionKey,
                                         defaultTimeStamp);
}
...
void Preferences::setTimePoint(const QString& key,
                               const std::chrono::system_clock::time_point& timepoint)
{
    QMutexLocker locker(&mutex);
    assert(logged());
    auto timePointMillis = std::chrono::time_point_cast<std::chrono::milliseconds>(timepoint)
                               .time_since_epoch()
                               .count();
...
void Preferences::setTransferOverQuotaDialogLastExecution(
...
void Preferences::setTransferOverQuotaOsNotificationLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
std::chrono::system_clock::time_point
    Preferences::getTransferAlmostOverQuotaOsNotificationLastExecution()
{
    return getTimePoint(transferAlmostOverQuotaOsNotificationLastExecutionKey);
}

void Preferences::setTransferAlmostOverQuotaOsNotificationLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setTransferAlmostOverQuotaUiAlertLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setTransferOverQuotaUiAlertLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setTransferOverQuotaSyncDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
std::chrono::system_clock::time_point
    Preferences::getTransferOverQuotaDownloadsDialogLastExecution()
{
    return getTimePoint(transferOverQuotaDownloadsDialogLastExecutionKey);
}

void Preferences::setTransferOverQuotaDownloadsDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
std::chrono::system_clock::time_point
    Preferences::getTransferOverQuotaImportLinksDialogLastExecution()
{
    return getTimePoint(transferOverQuotaImportLinksDialogLastExecutionKey);
}

void Preferences::setTransferOverQuotaImportLinksDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setTransferOverQuotaStreamDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setStorageOverQuotaUploadsDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
void Preferences::setStorageOverQuotaSyncsDialogLastExecution(
    std::chrono::system_clock::time_point timepoint)
{
...
bool Preferences::isAnyNotificationEnabled(bool includingGeneralSwitch)
{
    ...
    if (!includingGeneralSwitch || isGeneralSwitchNotificationsOn())
    {
        for (int index = notificationsTypeUT(NotificationsTypes::GENERAL_SWITCH_NOTIFICATIONS) + 1;
             index < notificationsTypeUT(NotificationsTypes::LAST);
             ++index)
        {
...
bool Preferences::isGeneralSwitchNotificationsOn()
{
    ...
    auto generalSwitchNotificationsKey =
        notificationsTypeToString(NotificationsTypes::GENERAL_SWITCH_NOTIFICATIONS);

    if (!generalSwitchNotificationsKey.isEmpty())
    {
        generalSwitchNotificationsValue =
            getValueConcurrent<bool>(generalSwitchNotificationsKey, defaultShowNotifications);
    }
...
{
    QVariant deprecatedGlobalNotifications =
        getValueConcurrent<QVariant>(showDeprecatedNotificationsKey);
...
{
    auto value =
        getValueConcurrent<int>(stalledIssuesModeKey, static_cast<int>(defaultStalledIssuesMode));
...
int Preferences::parallelDownloadConnections()
{
    return getValueConcurrent<int>(parallelDownloadConnectionsKey,
                                   defaultParallelDownloadConnections);
}
...
{
    assert(logged());
    return getValueConcurrent<unsigned long long>(upperSizeLimitValueKey,
                                                  defaultUpperSizeLimitValue);
}
...
{
    assert(logged());
    return getValueConcurrent<unsigned long long>(lowerSizeLimitValueKey,
                                                  defaultLowerSizeLimitValue);
}
...
QString Preferences::proxyHostAndPort()
{
    ...
    {
        proxy = QString::fromUtf8("[") + hostname + QString::fromLatin1("]:") +
...
QStringList Preferences::getPreviousCrashes()
{
    ...
    previousCrashes = mSettings->value(previousCrashesKey)
                          .toString()
...
QSet<MegaHandle> Preferences::getDisabledSyncTags()
{
    ...
    QStringList stringTagList = getValueConcurrent<QString>(disabledSyncsKey)
                                    .split(QString::fromUtf8("0x1E"), Qt::SkipEmptyParts);
...
{
    excludedSyncNames = getValue<QString>(excludedSyncNamesKey)
                            .split(QString::fromLatin1("\n", Qt::SkipEmptyParts));
    ...
    excludedSyncPaths = getValue<QString>(excludedSyncPathsKey)
                            .split(QString::fromLatin1("\n", Qt::SkipEmptyParts));
...
void Preferences::readFolders()
{
    ...
    for (int i = 0; i < numSyncs; i++)
    {
        ...
        auto sc =
            std::make_shared<SyncSettings>(mSettings->value(configuredSyncsKey).value<QString>());
        if (sc->backupId())
        {
        ...
        else
        {
            MegaApi::log(MegaApi::LOG_LEVEL_WARNING,
                         QString::fromLatin1("Reading invalid Sync Setting!").toUtf8().constData());
        }
...
QList<SyncData> Preferences::readOldCachedSyncs(int* cachedBusinessState,
                                                int* cachedBlockedState,
                                                int* cachedStorageState,
                                                QString email)
{
    QMutexLocker qm(&mutex);
    oldSyncs.clear();

    // if not logged in & email provided, read old syncs from that user and load new-cache sync from
    // prev session
    ...
    if (!instance()->logged() && !email.isEmpty())
    {
        ...
        if (temporarilyLoggedPrefs)
        {
            MegaApi::log(
                MegaApi::LOG_LEVEL_DEBUG,
                QString::fromUtf8("Migrating syncs data to SDK cache from previous session")
                    .toUtf8()
                    .constData());
        }
        else
    ...
    if (cachedBusinessState)
        *cachedBusinessState = getValue<int>(businessStateQKey, -2);
    if (cachedBlockedState)
        *cachedBlockedState = getValue<int>(blockedStateQKey, -2);
    if (cachedStorageState)
        *cachedStorageState = getValue<int>(storageStateQKey, MegaApi::STORAGE_STATE_UNKNOWN);
    ...
    for (int i = 0; i < numSyncs; i++)
    {
        ...
        MegaApi::log(
            ...
            QString::fromLatin1("Reading old cache sync setting ... ").toUtf8().constData());

        if (temporarilyLoggedPrefs) // coming from old session
        {
            MegaApi::log(MegaApi::LOG_LEVEL_WARNING,
                         QString::fromLatin1(
                             " ... sync configuration rescued from old session. Set as disabled.")
                             .toUtf8()
                             .constData());

            enabled = false; // syncs coming from old sessions are now considered unsafe to continue
                             // automatically
            // Note: in this particular case, we are not showing any error in the sync (since that
            // information is not carried out to the SDK)
        }
        ...
        oldSyncs.push_back(SyncData(
            ...
            mSettings
                ->value(megaFolderHandleKey, QVariant::fromValue<mega::MegaHandle>(INVALID_HANDLE))
                .value<mega::MegaHandle>(),
...
void Preferences::saveOldCachedSyncs()
{
    ...
    foreach(SyncData osd, oldSyncs) // normally if no errors happened it'll be empty
    {
        ...
        mSettings->setValue(megaFolderHandleKey,
                            QVariant::fromValue<mega::MegaHandle>(osd.mMegaHandle));
...
void Preferences::removeSyncSetting(std::shared_ptr<SyncSettings> syncSettings)
{
    ...
    {
        MegaApi::log(MegaApi::LOG_LEVEL_ERROR,
                     QString::fromLatin1("Removing invalid Sync Setting!").toUtf8().constData());
        return;
    }
...
void Preferences::writeSyncSetting(std::shared_ptr<SyncSettings> syncSettings)
{
    ...
    else
    {
        MegaApi::log(
            ...
            QString::fromLatin1("Writting sync settings before logged in").toUtf8().constData());
    }
}
...
void Preferences::overridePreferences(const QSettings& settings)
{
    overridePreference(settings,
                       QString::fromUtf8("OQ_DIALOG_INTERVAL_MS"),
                       Preferences::OQ_DIALOG_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("OQ_NOTIFICATION_INTERVAL_MS"),
                       Preferences::OQ_NOTIFICATION_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("ALMOST_OS_INTERVAL_MS"),
                       Preferences::ALMOST_OQ_UI_MESSAGE_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("OS_INTERVAL_MS"),
                       Preferences::OQ_UI_MESSAGE_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("PAYWALL_NOTIFICATION_INTERVAL_MS"),
                       Preferences::PAYWALL_NOTIFICATION_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("USER_INACTIVITY_MS"),
                       Preferences::USER_INACTIVITY_MS);
    overridePreference(settings,
                       QString::fromUtf8("STATE_REFRESH_INTERVAL_MS"),
                       Preferences::STATE_REFRESH_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("NETWORK_REFRESH_INTERVAL_MS"),
                       Preferences::NETWORK_REFRESH_INTERVAL_MS);

    overridePreference(settings,
                       QString::fromUtf8("TRANSFER_OVER_QUOTA_DIALOG_DISABLE_DURATION_MS"),
                       Preferences::OVER_QUOTA_DIALOG_DISABLE_DURATION);
    overridePreference(settings,
                       QString::fromUtf8("TRANSFER_OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION_MS"),
                       Preferences::OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION);
    overridePreference(settings,
                       QString::fromUtf8("TRANSFER_OVER_QUOTA_UI_ALERT_DISABLE_DURATION_MS"),
                       Preferences::OVER_QUOTA_UI_ALERT_DISABLE_DURATION);
    overridePreference(settings,
                       QString::fromUtf8("TRANSFER_ALMOST_OVER_QUOTA_UI_ALERT_DISABLE_DURATION_MS"),
                       Preferences::ALMOST_OVER_QUOTA_UI_ALERT_DISABLE_DURATION);
    overridePreference(
        settings,
        QString::fromUtf8("TRANSFER_ALMOST_OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION_MS"),
        Preferences::ALMOST_OVER_QUOTA_OS_NOTIFICATION_DISABLE_DURATION);
    overridePreference(settings,
                       QString::fromUtf8("OVER_QUOTA_ACTION_DIALOGS_DISABLE_TIME_MS"),
                       Preferences::OVER_QUOTA_ACTION_DIALOGS_DISABLE_TIME);

    overridePreference(settings,
                       QString::fromUtf8("MIN_UPDATE_STATS_INTERVAL"),
                       Preferences::MIN_UPDATE_STATS_INTERVAL);
    overridePreference(settings,
                       QString::fromUtf8("MIN_UPDATE_CLEANING_INTERVAL_MS"),
                       Preferences::MIN_UPDATE_CLEANING_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("MIN_UPDATE_NOTIFICATION_INTERVAL_MS"),
                       Preferences::MIN_UPDATE_NOTIFICATION_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("MIN_REBOOT_INTERVAL_MS"),
                       Preferences::MIN_REBOOT_INTERVAL_MS);
    overridePreference(settings,
                       QString::fromUtf8("MIN_EXTERNAL_NODES_WARNING_MS"),
                       Preferences::MIN_EXTERNAL_NODES_WARNING_MS);
    overridePreference(settings,
                       QString::fromUtf8("MIN_TRANSFER_NOTIFICATION_INTERVAL_MS"),
                       Preferences::MIN_TRANSFER_NOTIFICATION_INTERVAL_MS);

    overridePreference(settings,
                       QString::fromUtf8("UPDATE_INITIAL_DELAY_SECS"),
                       Preferences::UPDATE_INITIAL_DELAY_SECS);
    overridePreference(settings,
                       QString::fromUtf8("UPDATE_RETRY_INTERVAL_SECS"),
                       Preferences::UPDATE_RETRY_INTERVAL_SECS);
    overridePreference(settings,
                       QString::fromUtf8("UPDATE_TIMEOUT_SECS"),
                       Preferences::UPDATE_TIMEOUT_SECS);
    overridePreference(settings,
                       QString::fromUtf8("MAX_LOGIN_TIME_MS"),
                       Preferences::MAX_LOGIN_TIME_MS);
    overridePreference(settings,
                       QString::fromUtf8("PROXY_TEST_TIMEOUT_MS"),
                       Preferences::PROXY_TEST_TIMEOUT_MS);
    overridePreference(settings,
                       QString::fromUtf8("MAX_IDLE_TIME_MS"),
                       Preferences::MAX_IDLE_TIME_MS);
    overridePreference(settings,
                       QString::fromUtf8("MAX_COMPLETED_ITEMS"),
                       Preferences::MAX_COMPLETED_ITEMS);

    overridePreference(settings,
                       QString::fromUtf8("MUTEX_STEALER_MS"),
                       Preferences::MUTEX_STEALER_MS);
    overridePreference(settings,
                       QString::fromUtf8("MUTEX_STEALER_PERIOD_MS"),
                       Preferences::MUTEX_STEALER_PERIOD_MS);
    overridePreference(settings,
                       QString::fromUtf8("MUTEX_STEALER_PERIOD_ONLY_ONCE"),
                       Preferences::MUTEX_STEALER_PERIOD_ONLY_ONCE);
}

void Preferences::updateFullName()
{
    auto fullNameRequest(
    ...
    connect(fullNameRequest.get(),
            &UserAttributes::FullName::separateNamesReady,
            this,
